...
fun RowListDemo(modifier: Modifier = Modifier) {
    ...
    val rowDataList = persistentListOf(
        ...
        RowData(
            ...
            subtitle =
                "Enabled button, with leading image content " +
                    "description, leading image does scale " +
                    "with font size, with trailing icon " +
                    "content description for open_in_new icon",
        ...
        RowData(
            ...
            subtitle =
                "Enabled button, with leading image content " +
                    "description, leading image doesn't " +
                    "scale with font size, with trailing " +
                    "icon content description for " +
                    "open_in_new icon. \n Click to toggle " +
                    "Row 8 button state.",
            clickEnabled = true,
            onClick = {
        ...
        RowData(
            ...
            subtitle =
                "Toggleable " +
                    "$toggleableRowButtonStateText button, " +
                    "no leading image content description, " +
                    "leading image does scale with font " +
                    "size, with trailing icon content " +
                    "description for open_in_new icon",
