 ...
 *
 * Implementations of [BaseScreenshotTestM3] would at minimum override the [generateComposeLayout]
 ...
 */
abstract class BaseScreenshotTestM3(nightMode: NightMode = NOTNIGHT) {
